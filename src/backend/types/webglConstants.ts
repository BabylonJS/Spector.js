...
export class WebGlConstants {
    ...
    public static readonly COMPLETION_STATUS_KHR: WebGlConstant = { name: "COMPLETION_STATUS_KHR", value: 37297, description: "Passed to getProgramParameter (KHR_parallel_shader_compile) to query whether an asynchronous shader/program link has completed. Returns true once the program is ready to use without blocking." };
