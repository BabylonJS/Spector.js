var createScene = function (engine, canvas) {
    ...
    materialSphere3.diffuseTexture = new BABYLON.Texture("/sample/assets/textures/checker.png", scene, false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);

    //Creation of a material with translated texture
    var materialSphere4 = new BABYLON.StandardMaterial("texture4", scene);
    materialSphere4.diffuseTexture = new BABYLON.Texture("/sample/assets/textures/checker.png", scene);
    ...
    materialSphere5.diffuseTexture = new BABYLON.Texture("/sample/assets/textures/checker.png", scene, false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
    ...
    materialSphere6.diffuseTexture = new BABYLON.Texture("/sample/assets/textures/checker.png", scene);
    materialSphere6.diffuseTexture.hasAlpha = true;//Have an alpha
    materialSphere6.backFaceCulling = false;//Show all the faces of the element

    //Creation of a repeated textured material
    var materialPlane = new BABYLON.StandardMaterial("texturePlane", scene);
    materialPlane.diffuseTexture = new BABYLON.Texture("/sample/assets/textures/checker.png", scene, false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
